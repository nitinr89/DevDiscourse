...
{
    public class LawGovernanceNewsViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext _db;
        public LawGovernanceNewsViewComponent(ApplicationDbContext _db)
        {
            this._db = _db;
        }
      ...
      .Where(dn => dn.DevNews.CreatedOn > twoMonth && dn.DevNews.AdminCheck == true &&
                   dn.DevNews.Sector == "11" && dn.Region.Title == regionTitle && dn.DevNews.IsSponsored == false)
      ...
      .ToList();
                ...
                var sponsoredNews = (from sn in _db.SponsoredNews
                                     ...
                                     where sn.IsActive == true && n.AdminCheck == true && sn.Sector == 11 && sn.EndTime > DateTime.UtcNow
