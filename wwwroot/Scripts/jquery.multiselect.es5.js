...
(function ($, window, document, undefined) {
    ...
    var pluginName = "multiselect",
        ...
        onMaxNumExceeded: function onMaxNumExceeded() {
    ...
    $.extend(Plugin.prototype, {
        init: function init() {
            ...
            $.each(el, function () {
                ...
                if (jSelectElemId == '' || !o.preferIdOverName) {
                    ...
                    if (jSelectElemId == '') {
                        self.error('Can\'t convert element to checklist.\nYour SELECT element must' + ' have a "name" attribute and/or an "id" attribute specified.');
                        return $;
                    }
                }
                ...
                var convertListItemsToCheckboxes = function convertListItemsToCheckboxes() {
                    ...
                    $(this).replaceWith('<li tabindex="0"><input type="checkbox" value="' + checkboxValue + '" name="' + checkboxName + '" id="' + checkboxId + '" ' + selected + disabled + ' /><label for="' + checkboxId + '"' + disabledClass + '>' + labelText + '</label></li>');
                    // Hide the checkboxes.
                ...
                $('optgroup', jSelectElem).each(function (i) {
                    ...
                    $(this).replaceWith('<li class="' + o.cssOptgroup + '">' + '<input type="checkbox" class="' + o.cssOptgroup + '" id="' + jSelectElemId + '_' + o.cssOptgroup + '_' + i + '">' + '<label for="' + jSelectElemId + '_' + o.cssOptgroup + '_' + i + '" class="leaveRoomForCheckbox">' + $(this).attr('label') + '</label>' + '</li>' + $(this).html());
                });
                ...
                // the div as well.
                jSelectElem.replaceWith('<div id="' + jSelectElemId + '" class="' + o.cssContainer + '"><div id="' + checklistId + '">' + '<ul>' + jSelectElem.html() + '</ul></div></div>');
                ...
                var toggleDivGlow = function toggleDivGlow() {
                ...
                var moveToNextLi = function moveToNextLi() {
                ...
                var check = function check(event) {
                    ...
                    if (o.maxNumOfSelections != -1 && numOfItemsChecked > o.maxNumOfSelections && !$('input', this).attr('checked')) {
                ...
                var updateLIStyleToMatchCheckedStatus = function updateLIStyleToMatchCheckedStatus(checkbox) {
                    if (checkbox.checked) {
                ...
                var handFocusToLI = function handFocusToLI() {
                ...
                var fixFormElems = function fixFormElems(event) {
                ...
                var showSelectedItems = function showSelectedItems() {
                    ...
                    $('label', checklistDivId).each(function () {
                        ...
                        if ($(this).parent().hasClass(o.cssChecked)) {
                            ...
                            $('<li class="">' + labelText + '</li>').on('click.remove', function () {
        ...
        updateChecklist: function updateChecklist(action, checklistElem, selector) {
            ...
            var disableDynamicList = function disableDynamicList(checklistLength) {
            ...
            var enableDynamicList = function enableDynamicList() {
        ...
        addSearchBox: function addSearchBox(jSelectElem, checklistDivId, w, o) {
            ...
            var showAllSelectOptions = function showAllSelectOptions() {
                $('label', checklistDivId).each(function () {
                    if (o.animateSearch !== false) $(this).parent('li').slideDown(o.animateSearch);else $(this).parent('li').show();
                });
            };

            var blurSearchBox = function blurSearchBox() {
            ...
            var initSearchBox = function initSearchBox() {
                ...
                $(checklistDivId).before('<div class="findInList" id="' + jSelectElem.attr('id') + '_findInListDiv">' + '<input type="text" value="' + o.searchBoxText + '" id="' + jSelectElem.attr('id') + '_findInList" class="' + o.cssBlurred + ' ' + o.cssContainsPlaceholder + '" /></div>');
                ...
                .on('blur.blurSearchBox', blurSearchBox).on('keyup', function (event) {
                    ...
                    $('label', checklistDivId).each(function () {
                        ...
                        if (!$curLabel.is(':disabled')) {
                            ...
                            if (curItem.indexOf(typedText) == -1) {
                                if (o.animateSearch !== false) $curLabel.parent('li').slideUp(o.animateSearch);else $curLabel.parent('li').hide();
                            } else {
                                if (o.animateSearch !== false) $curLabel.parent('li').slideDown(o.animateSearch);else $curLabel.parent('li').show();
                            }
                        }
                    });
        ...
        addActionBox: function addActionBox(jSelectElem, checklistDivId, w, o) {
            var self = this;

            var initActionBox = function initActionBox() {

                $(checklistDivId).after('<div class="actionButtons" id="' + jSelectElem.attr('id') + '_actionButtons">' + '<span data-action="checkAll" >' + o.checkAllText + '</span> | ' + '<span data-action="clearAll" >' + o.uncheckAllText + '</span> | ' + '<span data-action="invert" >' + o.invertSelectText + '</span></div>');
