...
namespace Devdiscourse.Controllers.ViewComponents
{
    ...
    .Where(dn => dn.DevNews.CreatedOn > twoMonth && dn.DevNews.AdminCheck == true &&
                dn.DevNews.Sector == "2" && dn.Region.Title == regionTitle && dn.DevNews.IsSponsored == false)
    ...
    .ToList();
                ...
                var sponsoredNews = (from sn in _db.SponsoredNews
                                     ...
                                     where sn.IsActive == true && n.AdminCheck == true && sn.Sector == 2 && sn.EndTime > DateTime.UtcNow
