...
namespace Devdiscourse.Helper
{
    public class SeoFriendlySecondRoute
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            if (path != null && (path.StartsWith("/article/") || path.StartsWith("/news/") || path.StartsWith("/live-discourse") || path.StartsWith("/ContentCreator/ContentDetails/") || path.StartsWith("/media-partner-event/")))
            {
