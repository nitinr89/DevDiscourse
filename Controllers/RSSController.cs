        ...
        public async Task<IActionResult> GoogleNews(int? id)
        {
            ...
            using (var writer = XmlWriter.Create(sb, settings))
            {
                ...
                foreach (var item in search)
                {
                    ...
                    var newsImage = imageUrl.IndexOf("devdiscourse.blob.core.windows.net") != -1 ? $"https://www.devdiscourse.com/img?imageUrl={imageUrl}" : "https://www.devdiscourse.com/img?imageUrl=" + string.Concat("https://www.devdiscourse.com", imageUrl);
