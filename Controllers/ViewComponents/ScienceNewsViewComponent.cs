...
{
    public class ScienceNewsViewComponent : ViewComponent
    {
        private readonly ApplicationDbContext _db;
        public ScienceNewsViewComponent(ApplicationDbContext db)
        {
            _db = db;
        }
    ...
    .Where(dn => dn.DevNews.CreatedOn > twoMonth && dn.DevNews.AdminCheck == true &&
                 dn.DevNews.Sector == "15" && dn.Region.Title == regionTitle && dn.DevNews.IsSponsored == false)
    ...
    .ToList();
                ...
                var sponsoredNews = (from sn in _db.SponsoredNews
                                     ...
                                     where sn.IsActive == true && n.AdminCheck == true && sn.Sector == 15 && sn.EndTime > DateTime.UtcNow
