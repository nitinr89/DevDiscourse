    ...
    public class AgencyWireController : Controller
    {
        ...
        public PartialViewResult GetNewsAnalysisItems(string region, string type, int? page)
        {
            ...
            else
            {
                ...
                var userRegion = reg != null && reg.Title != null ? regionTitle = reg.Title : regionTitle = region;

                var search = _db.RegionNewsRankings
                    .Where(a => a.DevNews.AdminCheck == true && a.Region.Title == userRegion && a.DevNews.CreatedOn > oneMonth)
