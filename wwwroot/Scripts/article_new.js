            ...
            $.ajax({
                ...
                success: function (result) {
                    $.each(result, function (i, data) {
                        ...
                        var imageUrl = data.imageUrl.indexOf("devdiscourse.blob.core.windows.net") != -1 ? "/img?imageUrl=" + data.imageUrl : "/img?imageUrl=" + "https://www.devdiscourse.com" + data.imageUrl;
                        ...
                        if (data.type == 'News') {
                            ...
                            var authorImage = '';
                            if (data.themes != null) {
                                authorImage = data.themes.IndexOf("devdiscourse.blob.core.windows.net") != -1 ? "/img?imageUrl=" + data.themes : "/img?imageUrl=" + 'https://www.devdiscourse.com' + data.themes;
                            } else {
                                authorImage = data.avatar;
                            }
                            source = '<li><a href = "/Home/AuthorArticles?fl=' + data.author.Trim() + '"> <img class="img-circle author-avatar" src="' + authorImage + '&width=30&height=30&mode=crop" onerror="this.src=&#39;/img?imageUrl=https://www.devdiscourse.com/AdminFiles/Logo/img_avatar.png&width=30&height=30&mode=crop&#39;" alt="' + data.author + '" />' + data.author.Trim() + '</a></li>';
                        }
        ...
        $.get('/api/Search/GetHomeVideoNews/' + _region, function (data) {
            ...
            $.each(data.splice(0, 4), function (i, item) {
                ...
                if (item.fileThumbUrl != null && item.fileThumbUrl != "/images/defaultImage.jpg" && item.fileThumbUrl != "/images/newstheme.jpg" && item.fileThumbUrl != "/images/sector/all_sectors.jpg") {
                    newsImage = item.fileThumbUrl.indexOf("devdiscourse.blob.core.windows.net") != -1 ? "/img?imageUrl=" + item.fileThumbUrl : "/img?imageUrl=" + "https://www.devdiscourse.com" + item.fileThumbUrl;
                }
